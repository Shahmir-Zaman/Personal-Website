...
const AvatarCanvas = ({ cameraZ = 4, floatSpeed = 1.5, avatarPosition = [0.05, -1.2, 0.3] }) => (
    <Canvas
...
const AvatarWidget = ({ isWidget }) => {
    ...
    return (
        <>
            {/* Fixed widget (after scroll past hero) */}
            {isWidget && (
                <div
                ...
                >
                    <AvatarCanvas cameraZ={4} floatSpeed={2} />
                </div>
            )}
        </>
    );
